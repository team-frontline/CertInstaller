...
public class CertInstaller {
    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidCSRParamException, IOException, ExecutionException, InterruptedException {
...
//        }
        ...
        Map<String, String> csrParamMap = new HashMap<String, String>();
        csrParamMap.put("commonName", "testing321.org");
        csrParamMap.put("organizationUnit", "MSChain");
        csrParamMap.put("organizationName", "Frontline.org");
        csrParamMap.put("localityName", "Colombo");
        csrParamMap.put("stateName", "West");
        csrParamMap.put("country", "SL");
        certManager.initiateCertificate("src/main/resources","test97",csrParamMap);
    }
}